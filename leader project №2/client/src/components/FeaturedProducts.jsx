                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {featuredProducts.map(product => (
                            <div 
                                ...
                                className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl hover:scale-105 transition"
                            >
                                    ...
                                    <div className="flex justify-between items-center mt-4">
                                        ...
                                        {user && (
                                            <Link 
                                                ...
                                                className="bg-blue-400 text-white px-4 py-2 rounded hover:bg-blue-500 transition text-sm font-semibold"
                                            >
                                                View
                                            </Link>
                                        )}
                    ...
                    {user && (
                        <div className="text-center mt-12">
                            <Link 
                                to="/shop"
                                className="bg-blue-600 text-white px-10 py-3 rounded-lg font-bold hover:bg-blue-700 transition"
                            >
                                View All Products
                            </Link>
                        </div>
