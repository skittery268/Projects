                    ...
                    filteredProducts.map(product => {
                        return (
                            <div key={product._id} className="relative w-70 flex justify-center items-center flex-col shadow rounded-[20px] h-100 hover:shadow-lg duration-300 group">
                                ...
                                <button className="absolute bg-white h-10 w-30 border border-gray-300 rounded-full -bottom-3 opacity-0 group-hover:opacity-100 transition-all duration-400 group-hover:bottom-5 hover:bg-[#21B3F1] hover:text-white cursor-pointer">Add To Cart</button>
                            </div>
                        )
                    })
                }
