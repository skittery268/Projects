...
const Register = () => {
    ...
    return (
        <section className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-300/40">
            ...
            <p className="mt-2 text-sm text-slate-600">Start organizing your client workflow in minutes.</p>

            <form onSubmit={(e) => { handleSubmit(e, register); resetForm() }} className="mt-6 space-y-4">
                <div>
                    <label htmlFor="name" className="mb-1 block text-sm font-semibold text-slate-700">Full Name</label>
                    <input
                        id="name"
                        type="text"
                        name="name"
